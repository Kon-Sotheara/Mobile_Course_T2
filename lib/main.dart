...
class ColorTapsScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    ColorTapsNotifier notifier = context.watch<ColorTapsNotifier>();
      ...
      body: Column(
        children: [
          ColorTap(
            ...
            onTap: () => notifier.increment(ColorType.red),
          ),
          ColorTap(
            type: ColorType.blue,
            tapCount: notifier.blueTapCount,
            onTap: () => notifier.increment(ColorType.blue),
          ),
        ],
      ),
    );
...
class StatisticsScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    ColorTapsNotifier colorNotify = context.read<ColorTapsNotifier>();
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Text(
              'Red Taps: ${colorNotify.redTapCount}',
              style: TextStyle(fontSize: 24),
            ),
            Text(
              'Blue Taps: ${colorNotify.blueTapCount}',
              style: TextStyle(fontSize: 24),
            ),
          ],
        ),
